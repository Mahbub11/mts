...
import { cBannar, eBananr, project1, project3, project4 } from "@/public";
import Image from "next/image";

export default function HeroCaseFourStudy() {
  return (
    <section
      className="w-full 
        ...
        >
          <div className="sm:w-full w-[30%]">
            <div className="flex flex-col gap-2 sm:justify-center">
              ...
              >
                Design & development of a platform for <span className="text-btn_clr">Construction Company CRM</span> 
                <br />
              </h2>
            </div>
