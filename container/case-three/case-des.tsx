...
import CaseThreeBreakDown from "./case-breakdown";
import DetailCaseThreeStudy from "./detail-case-section";

export default function CaseThreeDetail() {
    ...
    <div className="w-full" ref={container}>
      ...
      >
        <div className=" px-[2rem] py-10 ">
          <CaseThreeBreakDown></CaseThreeBreakDown>
          <div className="mt-[5rem]">
            <DetailCaseThreeStudy></DetailCaseThreeStudy>
          </div>
        </div>
