...
const TextBannarSection: React.FC = () => {
  ...
  return (
    <section
      className="w-full sm:mt-[1rem] md:mt-[15rem]
     lg:mt-[15rem] sm:text-[3rem] md:text-[5rem] lg:text-[5rem] overflow-hidden relative
    font-montreal"
    >
