...
import DiscoveryCaseTwoStudy from "./discovery-case-study";
import DesignCaseTwoStudy from "./design-case-study";
import DevelopmentCaseTwoStudy from "./development-case-study";
...
const DetailCaseThreeStudy: React.FC = () => {
  useEffect(() => {
    (async () => {
  ...
  return (
    <div className=" mx-4 my-8">
      <div className="flex-col  justify-center items-center ">
        <div>
          <h2 className="text-4xl font-bold mb-4 uppercase text-btn_clr">
            Discovery
          </h2>
          <DiscoveryCaseTwoStudy />
        </div>
        ...
        <div className="mt-[8rem]">
          ...
          <DesignCaseTwoStudy></DesignCaseTwoStudy>
        </div>
...
export default DetailCaseThreeStudy;
