...
import { eBananr, project1, project3, project4, rBannar } from "@/public";
import Image from "next/image";

export default function HeroCasetwoStudy() {
  return (
    <section
      className="w-full 
        ...
        >
          <div className="sm:w-full w-[30%]">
            <div className="flex flex-col gap-2 sm:justify-center">
              ...
              >
                Design & development of a platform for <span className="text-btn_clr">Realestate</span> Startup
                <br />
              </h2>
            </div>
